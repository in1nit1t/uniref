...
class InjectorTest(TestCase):
    ...
    def test_rw_pointer_array(self) -> None:
        if self.injector.bit_long == 32:
            ...
            self._test_rw_array_internal(8, uint64_random, self.injector.mem_read_pointer_array, self.injector.mem_write_pointer_array)
    ...
    def test_new_pointer(self) -> None:
        if self.injector.bit_long == 32:
            ...
            self._test_new_internal(uint64_random, self.injector.new_pointer)
    ...
    def test_new_pointer_array(self) -> None:
        if self.injector.bit_long == 32:
            ...
            self._test_new_array_internal(8, uint64_random, self.injector.new_pointer_array)
